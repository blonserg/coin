<template>
  <div>
    ...
    <div class="strategy-stock">
      <v-row>
        <v-col v-for="(item, i) in invests" :key="i" md="6">
          <v-card class="strategy-item_invest">
            <div class="strategy-head d-flex align-center">
              <div class="strategy-head_img">
            ...
            <div class="strategy-bottom d-flex justify-space-between align-center">
              <div class="strategy-bottom_info">
